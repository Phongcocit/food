...
export default {
  ...
  methods: {
    addToCart() {
      ...
      if (this.isCheckPaid && this.unpaidCart) {
        // Add the item to the unpaid cart
        axios
          .post(
            `https://634918dfa59874146b171fc0.mockapi.io/api/carts/${this.unpaidCart}/items`,
            payload
          )
          .then(() => {
            console.log("Added to unpaid cart");
          })
          .catch((error) => {
            console.log(error);
          });
        ...
        axios
          .post("https://634918dfa59874146b171fc0.mockapi.io/api/carts", {
            paid: false,
          })
          .then((response) => {
            ...
            axios
              .post(
                `https://634918dfa59874146b171fc0.mockapi.io/api/carts/${cartId}/items`,
                payload
              )
              .then(() => {
